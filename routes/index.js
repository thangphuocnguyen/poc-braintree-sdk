...
router.get('/checkouts/new', (req, res) => {
  ...
  //   },
  //   function(err, result) {
  //     console.log('ENPI RESULT:', result);
  //     // result.success;
  //     // // true
...
router.post('/checkouts', (req, res) => {
  ...
  console.log('payment_method_nonce', paymentMethodNonce);

  const payment = gateway.customer.create(
    {
      firstName: 'Jen',
      lastName: 'Smith',
      company: 'Braintree',
    ...
    function(err, result) {
      console.log('ENPI RESULT:', result);
      console.log('ENPI RESULT > customer:', result.customer);
      console.log('ENPI RESULT >> creditCards:', result.customer.creditCards);
      console.log('ENPI RESULT >> paymentMethods:', result.customer.paymentMethods);

      const responsed = JSON.stringify(result, undefined, 4);

      res.render('checkouts/result', { result, responsed });
    }
  );
